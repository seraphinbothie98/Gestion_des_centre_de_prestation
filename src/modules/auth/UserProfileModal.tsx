      ...
      <div className="space-y-4 pt-1">
        ...
        {activeTab === 'INFO' && (
          <div className="space-y-4">
            {/* HERO PROFILE CARD */}
            <div className="p-5 bg-gradient-to-r from-slate-900 via-emerald-950 to-slate-900 text-white rounded-2xl shadow-lg border border-brand-900/50 flex flex-col sm:flex-row items-center sm:items-start gap-4 text-center sm:text-left">
            ...
            <div className="p-3 bg-slate-100 dark:bg-slate-800/80 border border-slate-200 dark:border-slate-700 rounded-xl text-xs text-slate-800 dark:text-slate-200 flex items-start gap-2.5">
              <ShieldCheck className="w-4 h-4 text-brand-600 shrink-0 mt-0.5" />
              <div>
                <span className="font-bold">Indépendance stricte du Profil :</span> Vos informations personnelles (Photo, Nom, Prénom, Téléphone, Email) appartiennent à votre compte utilisateur personnel (<code className="bg-slate-200 dark:bg-slate-900 px-1 py-0.2 rounded font-mono text-[10px]">user_id: {currentUser.id}</code>) et restent identiques même si vous changez d'agence active.
              </div>
            </div>
              ...
              <div className="p-3.5 bg-slate-50 dark:bg-slate-800/60 rounded-xl border border-slate-200 dark:border-slate-700 space-y-2">
                ...
                <div className="space-y-1.5">
                  <div className="flex justify-between">
                    ...
                    <span className="font-bold text-brand-600 dark:text-brand-400">{userRoleLabel}</span>
                  </div>
                  <div className="flex justify-between">
