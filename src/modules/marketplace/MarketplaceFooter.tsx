...
import { 
  ...
  HelpCircle, Heart, Award, ArrowRight, Truck, Clock, Sparkles, Lock, Shield
} from 'lucide-react';
...
export const MarketplaceFooter: React.FC<MarketplaceFooterProps> = ({
  ...
  return (
    <footer className="bg-slate-900 text-slate-400 border-t border-slate-800 pt-14 pb-8 selection:bg-red-500 selection:text-white">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-12 border-b border-slate-800">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
          <div className="flex items-center gap-3.5 p-4 rounded-2xl bg-slate-800/50 border border-slate-700/60">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-6 gap-8">
          ...
          <div className="lg:col-span-2 space-y-4">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-xl bg-slate-800 border border-slate-700 flex items-center justify-center text-white shadow-md">
                <Store className="w-5 h-5 text-amber-400" />
              </div>
              <div>
                <div className="flex items-center gap-1">
                  <span className="text-lg font-black text-red-500">GUINÉE</span>
                  <span className="text-lg font-black text-amber-400">BOUTIQUES</span>
                </div>
          ...
          <div className="space-y-3">
            <h4 className="text-xs font-black text-white uppercase tracking-wider">Marketplace</h4>
            <ul className="space-y-2 text-xs">
              ...
              <li>
                <button onClick={() => onNavigateSection('categories')} className="hover:text-amber-400 transition-colors">
              ...
              <li>
                <button onClick={() => onNavigateSection('how-it-works')} className="hover:text-amber-400 transition-colors">
                  Comment ça marche ?
                </button>
              </li>
              <li>
          ...
          {/* Column 2: Espace Clients */}
          <div className="space-y-3">
            <h4 className="text-xs font-black text-white uppercase tracking-wider">Espace Clients</h4>
            <ul className="space-y-2 text-xs">
              <li>
                <button 
                  onClick={() => onOpenOrders ? onOpenOrders() : onOpenLogin('CLIENT')} 
              ...
              <li>
                <button 
                  onClick={() => onOpenMessaging ? onOpenMessaging() : onOpenLogin('CLIENT')} 
              ...
              <li>
                <button onClick={() => onNavigateSection('how-it-works')} className="hover:text-slate-300 transition-colors">
          ...
          {/* Column 3: Vendeurs & Boutiques */}
          <div className="space-y-3">
            <h4 className="text-xs font-black text-amber-400 uppercase tracking-wider">Vendeurs & Boutiques</h4>
            <ul className="space-y-2 text-xs">
              <li>
                <button 
          ...
          {/* Column 4: Administration (Discreet) */}
          <div className="space-y-3">
            ...
            <ul className="space-y-2 text-xs">
              <li>
                <button 
                  ...
                  className="text-slate-400 hover:text-amber-400 font-semibold transition-colors flex items-center gap-1"
                  title="Accès réservé aux administrateurs de la plateforme"
                >
              ...
              <li>
                <span className="text-[11px] text-slate-500">
                  Réservé aux gérants et administrateurs autorisés
                </span>
              </li>
            </ul>
          </div>
